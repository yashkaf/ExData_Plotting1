...
# Create the plots in the active device
par(mfrow=c(2,2))
with(power,plot(Moment,Global_active_power,type="l",ylab="Global Active Power",xlab=""))
with(power,plot(Moment,Voltage,type="l",ylab="Voltage",xlab="datetime"))
...
with(power,plot(Moment,Global_reactive_power,type="l",xlab="datetime"))
